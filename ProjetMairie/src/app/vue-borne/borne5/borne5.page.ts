...
@Component({
  selector: 'app-borne5',
  templateUrl: './borne5.page.html',
  styleUrls: ['./borne5.page.scss'],
})
export class Borne5Page implements OnInit {
  ...
  /* Popover pour afficher un text où écrire des notes */ 
  ...
  ouvrirPageIndice1(){
    this.indice1=true;
    this.router.navigate(['borne5/indice1']);
  }
  /*Ouvrir l'indice 2*/

  ouvrirPageIndice2(){
    this.indice2=true;
    this.router.navigate(['borne5/indice2']);
  }

  /*Ouvrir page transition 6*/
