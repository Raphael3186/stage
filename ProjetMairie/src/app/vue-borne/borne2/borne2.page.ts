...
@Component({
  selector: 'app-borne2',
  templateUrl: './borne2.page.html',
  styleUrls: ['./borne2.page.scss'],
})
export class Borne2Page implements OnInit {
  ...
  ouvrirPageIndice1(){
    this.indice1 = true;
    this.router.navigate(['borne2/indice1']);
  }
  /*Ouvrir l'indice 2*/

  ouvrirPageIndice2(){
    this.indice2 = true;
    this.router.navigate(['borne2/indice2']);
  }

  /*Ouvrir page transition 3*/
  ...
  /* Traitement de la réponse numéro 2 */

  traitementReponse(){
      if((this.indice1 && this.indice2) && (this.reponse == null)){
      this.deuxiemeBorne(2);
    }
      ...
      if(this.reponse.indexOf("bus") >= 0 && this.reponse.indexOf("pavillon") >= 0){
        this.deuxiemeBorne(2);
      }else if(this.reponse.indexOf("bus") >= 0 || this.reponse.indexOf("pavillon") >= 0){
        this.showAlert();
      }else{
        this.errorAlert();
      }  
